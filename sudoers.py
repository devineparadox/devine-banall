...
@devine.on_message(filters.command(["addsudo"]) & filters.user(OWNER_ID))
...
@devine.on_message(filters.command(["delsudo", "rmsudo"]) & filters.user(OWNER_ID))
...
@devine.on_message(filters.command(["sudolist", "listsudo", "sudoers"]) & ~filters.user(BANNED_USERS))
